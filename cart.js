...
// for the proporties in this object, the data types i would use are a number for adress ( and a string to concantonate) and phone number , a boolean for if he is a regular or not,, and a string for their name , adress 
